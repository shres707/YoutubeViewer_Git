...
def scrape_comments_with_replies(url):
    ...
    df = pd.DataFrame({'Name': [i[0] for i in box], 'Comment': [i[1] for i in box],'Comment Id':[i[2] for i in box], 'Time': [i[3] for i in box],
                       'Likes': [i[4] for i in box], 'Reply Count': [i[5] for i in box]})
